...
public class CacheEnvConfigTest {
	...
	public static void main(String[] args) throws MalformedObjectNameException, InterruptedException, InstanceAlreadyExistsException, MBeanRegistrationException, NotCompliantMBeanException {
		...
		//register the MBean
		CacheEnvConfig mBean = new CacheEnvConfig();
		ObjectName name = new ObjectName("com.kt.bit.csm.blds.jmx:type=CacheEnvConfig");
		mbs.registerMBean(mBean, name);
		
		do{
            Thread.sleep(3000);
    		System.out.println(mBean.getTotalSettings());
        }while(true);	
